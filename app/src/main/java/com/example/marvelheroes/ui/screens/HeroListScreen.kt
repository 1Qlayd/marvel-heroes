...
import com.example.marvelheroes.models.MainViewModel
...
import com.example.marvelheroes.models.MainState
import com.example.marvelheroes.ui.HeroDetailScreen
import com.example.marvelheroes.ui.components.MainCard
...
fun HeroListScreen(
    ...
    Box(modifier = modifier.fillMaxSize()) {
        when (state) {
            ...
            is MainState.Error -> ErrorIndicator()
            is MainState.Success -> {
                HeroListContent(
                    modifier = modifier,
                    navController = navController,
                    superheroes = (state as MainState.Success).heroes
                )
            }
        }
    }
